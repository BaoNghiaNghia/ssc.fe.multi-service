...
function EditGoogleKey({ googleKeyState, setState }) {
    const dispatch = useDispatch();
    const [formCreateGoogleKey] = Form.useForm();

    const { isUpdateGoogkeKey, selectedRowData} = googleKeyState;
...
EditGoogleKey.propTypes = {
    googleKeyState: PropTypes.object,
    setState: PropTypes.func
};

export default EditGoogleKey;
