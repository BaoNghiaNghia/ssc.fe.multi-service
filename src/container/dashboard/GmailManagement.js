                ...
                <Table
                  ...
                  pagination={{
                    ...
                    showTotal(total, range) {
                        return <p className='mx-4 mt-1'>Tổng cộng <span style={{ fontWeight: 'bold' }}>{numberWithCommas(total || 0)}</span> tài khoản</p>;
                    },
                  ...
                  locale={{ emptyText: (
                    <div>
                      <Image src={require(`../../static/img/empty_order_4.svg`).default} alt="" width="250px" preview={false} style={{margin: '30px 0px', opacity: '35%'}}/>
